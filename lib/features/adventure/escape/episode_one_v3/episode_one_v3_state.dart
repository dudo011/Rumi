...
extension EpisodeOneV3StageMetadata on EpisodeOneV3Stage {
  ...
  String get objective => switch (this) {
    ...
    EpisodeOneV3Stage.revealTwelveDivisors =>
      '실험과 벽화를 함께 보고 빛나야 할 별자리 조각을 찾으세요.',
    ...
    EpisodeOneV3Stage.testTrackIntervals =>
      '4·5·6칸 간격을 모두 시험해 끝까지 이어지는 후보를 남기세요.',
    EpisodeOneV3Stage.connectFootprints =>
      '수학 조건과 현장 단서를 모두 만족하는 발자국만 순서대로 연결하세요.',
  ...
  String get problemPrompt => switch (this) {
    ...
    EpisodeOneV3Stage.orderTwelveDivisors => '찾은 12의 약수를 작은 수부터 차례로 누르세요.',
    EpisodeOneV3Stage.identifyFlowerpot =>
    ...
    EpisodeOneV3Stage.mapTwentyFourPins => '네 배열에 사용된 모든 변의 길이를 중복 없이 고르세요.',
    EpisodeOneV3Stage.orderStorageGlyphs => '짧은 변이 작은 건조판부터 오른쪽으로 문양을 누르세요.',
    EpisodeOneV3Stage.rejectFalseRecord =>
      'A·B·C 중 틀린 기록 하나를 고르고 5칸 시험판으로 확인하세요.',
    EpisodeOneV3Stage.useTraceFilters =>
      '세 도구를 모두 사용해 씨앗선·젖은 발자국·장화 자국을 따로 보이게 하세요.',
    EpisodeOneV3Stage.chooseTrackStart => '작은 둥근 발자국이 처음 나타난 지점을 고르세요.',
    EpisodeOneV3Stage.testTrackIntervals =>
      '4칸·5칸·6칸 간격을 모두 시험해 24번째 돌까지 정확히 이어지는지 확인하세요.',
    EpisodeOneV3Stage.connectFootprints =>
      '앞 단계에서 남긴 조건을 만족하는 젖은 발자국을 시작점부터 순서대로 연결하세요.',
    EpisodeOneV3Stage.orderEvidence => '다섯 사건 카드를 가장 먼저 일어난 일부터 차례로 놓으세요.',
    EpisodeOneV3Stage.chooseConclusion =>
  ...
  String get decisionRule => switch (this) {
    EpisodeOneV3Stage.identifyFragment => '모양뿐 아니라 홈의 위치와 긁힌 방향까지 모두 맞아야 합니다.',
    EpisodeOneV3Stage.testTwelveGroups =>
      '12개를 같은 수씩 묶었을 때 남는 것이 있는지 직접 시험합니다.',
    EpisodeOneV3Stage.revealTwelveDivisors =>
      '12를 나누어 나머지가 0이 되게 하는 수를 12의 약수라고 합니다.',
    EpisodeOneV3Stage.pairTwelveFactors => '두 수의 곱이 12이면 두 수는 12의 약수 한 쌍입니다.',
    EpisodeOneV3Stage.orderTwelveDivisors =>
      '1과 12도 약수에 포함하며, 곱셈 짝을 이용하면 빠뜨리지 않을 수 있습니다.',
    EpisodeOneV3Stage.identifyFlowerpot => '앞에서 얻은 문양은 오른쪽 방향과 잎 6개를 나타냅니다.',
    EpisodeOneV3Stage.assembleScratches =>
      '방향이 다른 바람종 자국은 사건 흔적이 아닙니다. 선택한 조각 수의 합도 확인하세요.',
    EpisodeOneV3Stage.arrangeEighteen => '18을 나누어 나머지가 0이 되는 수가 18의 약수입니다.',
    EpisodeOneV3Stage.removeDuplicateEighteen =>
      '1×18과 18×1처럼 순서만 바뀐 식은 같은 약수 쌍입니다.',
    EpisodeOneV3Stage.findMissingEighteen => '3과 어떤 수를 곱해야 18이 되는지 생각하세요.',
    EpisodeOneV3Stage.rejectNonDivisorEighteen =>
    ...
    EpisodeOneV3Stage.orderEvidence => '원인이 먼저, 그 결과가 나중에 오도록 배열합니다.',
    EpisodeOneV3Stage.chooseConclusion => '단서로 확인하지 못한 내용은 사실이 아니라 추측입니다.',
  ...
  String get interactionGuide => switch (this) {
    ...
    EpisodeOneV3Stage.testTwelveGroups ||
    EpisodeOneV3Stage.testTrackIntervals => '모든 시험 버튼을 한 번씩 눌러 결과를 본 뒤 확인하세요.',
    EpisodeOneV3Stage.orderTwelveDivisors ||
    EpisodeOneV3Stage.orderStorageGlyphs ||
    EpisodeOneV3Stage.connectFootprints ||
  ...
  String get submitLabel => switch (this) {
    EpisodeOneV3Stage.testTwelveGroups ||
    EpisodeOneV3Stage.testTrackIntervals => '실험 결과 확인하기',
    EpisodeOneV3Stage.orderTwelveDivisors ||
    EpisodeOneV3Stage.orderStorageGlyphs ||
    EpisodeOneV3Stage.connectFootprints ||
...
class EpisodeOneV3Snapshot {
  ...
  String get macroProgressLabel =>
      completed ? '대형 퍼즐 4/4' : '대형 퍼즐 $macroPuzzleIndex/4';
...
class EpisodeOneV3Controller extends ValueNotifier<EpisodeOneV3Snapshot> {
  ...
  static const correctEvidenceOrder = [
    'wind',
    'piece',
    'seed',
    'tracks',
  ...
  bool undoCurrentInput() {
    ...
    if (snapshot.evidenceOrder.isNotEmpty) {
      ...
      value = snapshot.copyWith(
        evidenceOrder: updated,
        message: '방금 놓은 사건 카드를 되돌렸어요.',
      );
      return true;
    }
    ...
    if (snapshot.orderedTexts.isNotEmpty) {
      ...
      value = snapshot.copyWith(
        orderedTexts: updated,
        message: '방금 입력한 문양을 되돌렸어요.',
      );
      return true;
    }
    ...
    if (snapshot.selectedNumbers.isNotEmpty) {
      ...
      value = snapshot.copyWith(
        ...
        message: '방금 선택한 수를 되돌렸어요.',
      );
      return true;
    }
    if (snapshot.activeFilters.isNotEmpty) {
      final updated = {...snapshot.activeFilters}
        ..remove(snapshot.activeFilters.last);
      value = snapshot.copyWith(
        activeFilters: updated,
        message: '방금 사용한 흔적 도구를 치웠어요.',
      );
      return true;
    }
    final updated = {...snapshot.testedValues}
      ..remove(snapshot.testedValues.last);
    value = snapshot.copyWith(
      testedValues: updated,
      message: '방금 한 실험을 되돌렸어요.',
    );
    return true;
  }
  ...
  void selectOrderedNumber(int number) {
    ...
    value = value.copyWith(
      ...
      message: number == 12
          ? '여섯 별자리 조각이 하나의 오른쪽 길을 만들었어요.'
          : '$number 문양이 올바른 자리에 놓였어요.',
    );
  }
  ...
  bool submitCurrent() {
    ...
    return switch (value.stage) {
      ...
      EpisodeOneV3Stage.testTwelveGroups => _submitTests(
        ...
        message: '나누어 남는 것이 없는 수를 약수라고 해요. 실험 결과를 이용해 12의 약수를 모두 찾아보세요.',
        activity: 2,
      ),
      EpisodeOneV3Stage.revealTwelveDivisors => _submitNumbers(
        const {1, 2, 3, 4, 6, 12},
        next: EpisodeOneV3Stage.pairTwelveFactors,
        message: '1·2·3·4·6·12는 12를 나누어 남지 않게 하므로 모두 12의 약수예요.',
        activity: 3,
      ),
      ...
      EpisodeOneV3Stage.arrangeEighteen => _submitNumbers(
        ...
        message: '1·2·3·6·9·18은 18을 나누어 남지 않게 하므로 모두 18의 약수예요.',
        activity: 6,
      ),
  ...
  void requestHint() {
    ...
    value = value.copyWith(
      hintLevel: level,
      message: _hintFor(value.stage, level),
    );
  }
  ...
  bool _submitFilters() {
    if (!value.activeFilters.containsAll(const {
      'dew',
      'stencil',
      'starlight',
    })) {
  ...
  bool _submitConclusion() {
    ...
    value = value.copyWith(
      ...
      hintLevel: 0,
      message:
          '씨앗이 먼저 떨어졌고 작은 생물이 그 뒤를 따라갔어요. 연못 끝에서 젖은 은빛 털과 잠긴 수문 문양을 발견했어요.',
    );
    return true;
  }
  ...
  void _advance({
    ...
    value = value.copyWith(
      ...
      trackPath: const [],
      evidenceOrder: const [],
      completedActivities: activity == null
          ? value.completedActivities
          : {...value.completedActivities, activity},
  ...
  String _hintFor(EpisodeOneV3Stage stage, int level) {
    final hints = switch (stage) {
      EpisodeOneV3Stage.identifyFragment => const [
        '받침대 오른쪽 홈의 테두리와 주변 물체의 모양을 비교하세요.',
        '홈에는 반달 모양의 긁힘이 이어져 있어요.',
        '반달 별조각을 선택해 확인하세요.',
      ],
      EpisodeOneV3Stage.testTwelveGroups => const [
        '성공한 묶음뿐 아니라 남는 별가루도 중요한 기록이에요.',
        '12를 2·3·4·5로 각각 나눈 나머지를 비교하세요.',
        '네 묶음판을 모두 시험하세요.',
      ],
      EpisodeOneV3Stage.revealTwelveDivisors => const [
        '실험에 없던 1개와 12개 배치는 벽화에 남아 있어요.',
        '곱해서 12가 되는 두 수를 모아 보세요.',
        '1·2·3·4·6·12 문양을 선택하세요.',
      ],
      EpisodeOneV3Stage.pairTwelveFactors => const [
        '서로 마주 보는 두 수를 곱하면 같은 별가루 수가 되어야 해요.',
        '작은 수 1, 2, 3부터 짝을 찾으세요.',
        '1×12, 2×6, 3×4를 연결하세요.',
      ],
      EpisodeOneV3Stage.orderTwelveDivisors => const [
        '회전판의 작은 별이 시작점이에요.',
        '찾은 수를 작은 순서로 놓으세요.',
        '1, 2, 3, 4, 6, 12 순서예요.',
      ],
      EpisodeOneV3Stage.identifyFlowerpot => const [
        '받침대가 남긴 잎 문양의 개수를 세어 보세요.',
        '오른쪽 화단에서 잎이 여섯 개인 문양을 찾으세요.',
        '6번 화분을 선택하세요.',
      ],
      EpisodeOneV3Stage.assembleScratches => const [
        '긁힘은 화분에만 있지 않아요.',
        '테두리 7개, 흙 5개, 바닥 6개를 모두 겹쳐 보세요.',
        '세 흔적 조각을 모두 선택하세요.',
      ],
      EpisodeOneV3Stage.arrangeEighteen => const [
        '18개가 남지 않는 배열만 기록하세요.',
        '곱해서 18이 되는 수를 모아 보세요.',
        '1·2·3·6·9·18을 선택하세요.',
      ],
      EpisodeOneV3Stage.removeDuplicateEighteen => const [
        '곱셈 순서만 바뀐 기록은 같은 배열이에요.',
        '1×18, 2×9, 3×6의 뒤집힌 기록을 찾으세요.',
        '18×1, 9×2, 6×3을 선택하세요.',
      ],
      EpisodeOneV3Stage.findMissingEighteen => const [
        '3과 짝이 되어 18을 만드는 수가 지워졌어요.',
        '18÷3을 생각해 보세요.',
        '6을 선택하세요.',
      ],
      EpisodeOneV3Stage.rejectNonDivisorEighteen => const [
        '18개를 나누었을 때 남는 숫자 잎을 찾으세요.',
        '4개씩 놓으면 2개가 남아요.',
        '4를 선택하세요.',
      ],
      EpisodeOneV3Stage.arrangeTwentyFour => const [
        '건조판의 두 변을 곱해 24가 되는지 확인하세요.',
        '짧은 변 1, 2, 3, 4의 짝을 찾으세요.',
        '1×24, 2×12, 3×8, 4×6을 선택하세요.',
      ],
      EpisodeOneV3Stage.mapTwentyFourPins => const [
        '네 배열의 양쪽 변에 있는 모든 수가 필요해요.',
        '중복을 제거하고 작은 수부터 모으세요.',
        '1·2·3·4·6·8·12·24를 선택하세요.',
      ],
      EpisodeOneV3Stage.orderStorageGlyphs => const [
        '문양 순서는 건조판의 짧은 변 순서와 같아요.',
        '작은 변 1, 2, 3, 4를 오른쪽 방향으로 읽으세요.',
        '별, 달, 잎, 물방울 순서예요.',
      ],
      EpisodeOneV3Stage.rejectFalseRecord => const [
        '원래 수보다 작다는 것만으로 약수가 되지는 않아요.',
        '기록 C를 고르고 5칸 시험판을 사용하세요.',
        '기록 C와 5칸 시험을 선택하세요.',
      ],
      EpisodeOneV3Stage.useTraceFilters => const [
        '한 도구는 젖은 흔적, 다른 도구는 크기, 또 다른 도구는 오래된 선을 보여줘요.',
        '세 도구의 결과를 겹쳐 비교하세요.',
        '물방울 렌즈, 흔적틀, 별가루 조명을 모두 사용하세요.',
      ],
      EpisodeOneV3Stage.chooseTrackStart => const [
        '둥근 발자국은 씨앗이 떨어지기 전에는 보이지 않아요.',
        '받침대 아래가 아니라 씨앗이 바닥에 닿은 지점을 찾으세요.',
        '두 번째 시작점을 선택하세요.',
      ],
      EpisodeOneV3Stage.testTrackIntervals => const [
        '끝까지 이어지는지 직접 확인해야 해요.',
        '24를 4, 5, 6으로 나눈 나머지를 비교하세요.',
        '4·5·6칸 간격을 모두 시험하세요.',
      ],
      EpisodeOneV3Stage.connectFootprints => const [
        '수학적으로 가능한 길이 두 개 남아 있어요.',
        '오른쪽 방향이고 젖은 돌로 이어지는 6칸 길을 찾으세요.',
        '0, 6, 12, 18, 24 순서로 연결하세요.',
      ],
      EpisodeOneV3Stage.orderEvidence => const [
        '원인이 먼저, 그 결과가 뒤에 와야 해요.',
        '바람, 조각, 씨앗, 발자국, 연못 순서로 생각하세요.',
        '바람→조각→씨앗→발자국→연못 순서예요.',
      ],
      EpisodeOneV3Stage.chooseConclusion => const [
        '확인한 사실과 아직 확인하지 못한 범인 추측을 구분하세요.',
        '발자국은 씨앗이 떨어진 뒤에 시작했어요.',
        '결론 B를 선택하세요.',
      ],
      EpisodeOneV3Stage.completed => const [
        'Episode 1 조사가 끝났어요.',
        '연못 아래의 수문은 Episode 2에서 열 수 있어요.',
        '정원으로 돌아가 다음 모험을 준비하세요.',
      ],
    };
